...
app.delete('/api/soft/:id', (req, res) => {
  ...
  con.query(sql, [req.params.id], (err, result) => {
    if (err) throw err;
    res.send({
      msg: { text: 'Oh, we put thing in the BIN!', type: 'success' },
    });
  });
});
app.delete('/api2/soft/:id', (req, res) => {
  ...
  con.query(sql, [req.params.id], (err, result) => {
    if (err) throw err;
    res.send({
      msg: { text: 'Oh, we put owner in the BIN!', type: 'success' },
    });
  });
});
...
app.put('/api/:id', (req, res) => {
  ...
  con.query(
    ...
    (err, result) => {
      if (err) throw err;
      res.send({
        msg: { text: 'Oh, we have edited this thing!', type: 'success' },
      });
    }
  );
});
app.put('/api2/:id', (req, res) => {
  ...
  con.query(sql, [req.body.name, req.params.id], (err, result) => {
    if (err) throw err;
    res.send({
      msg: { text: 'Oh, we have edited this owner!', type: 'success' },
    });
  });
});
